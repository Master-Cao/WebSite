...
name: taste-skill
description: >-
  Anti-slop frontend skill (tasteskill / design-taste-frontend) for landing
  pages, portfolios, and redesigns. Infers design language, sets VARIANCE /
  MOTION / DENSITY dials, and ships non-templated interfaces. Use when building
  or restyling professional frontend pages, or when the user mentions taste-skill,
  专业前端, 落地页, 作品集, 改版.
paths:
  - YJCabin.Client/web/**
---
...
Source: https://github.com/Leonxlnx/taste-skill (MIT, Copyright (c) 2026 Leonxlnx)
